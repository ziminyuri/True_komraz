...
--
-- Хост: 127.0.0.1
-- Время создания: Май 14 2019 г., 03:13
...
(129, 'Can add request_delivery3', 33, 'add_request_delivery3'),
(130, 'Can change request_delivery3', 33, 'change_request_delivery3'),
(131, 'Can delete request_delivery3', 33, 'delete_request_delivery3'),
(132, 'Can view request_delivery3', 33, 'view_request_delivery3'),
(133, 'Can add implemented', 34, 'add_implemented'),
(134, 'Can change implemented', 34, 'change_implemented'),
(135, 'Can delete implemented', 34, 'delete_implemented'),
(136, 'Can view implemented', 34, 'view_implemented'),
(137, 'Can add procurement_plan', 35, 'add_procurement_plan'),
(138, 'Can change procurement_plan', 35, 'change_procurement_plan'),
(139, 'Can delete procurement_plan', 35, 'delete_procurement_plan'),
(140, 'Can view procurement_plan', 35, 'view_procurement_plan'),
(141, 'Can add period', 36, 'add_period'),
(142, 'Can change period', 36, 'change_period'),
(143, 'Can delete period', 36, 'delete_period'),
(144, 'Can view period', 36, 'view_period'),
(145, 'Can add plan', 37, 'add_plan'),
(146, 'Can change plan', 37, 'change_plan'),
(147, 'Can delete plan', 37, 'delete_plan'),
(148, 'Can view plan', 37, 'view_plan'),
(149, 'Can add procurement_plan1', 38, 'add_procurement_plan1'),
(150, 'Can change procurement_plan1', 38, 'change_procurement_plan1'),
(151, 'Can delete procurement_plan1', 38, 'delete_procurement_plan1'),
(152, 'Can view procurement_plan1', 38, 'view_procurement_plan1'),
(153, 'Can add login', 39, 'add_login'),
(154, 'Can change login', 39, 'change_login'),
(155, 'Can delete login', 39, 'delete_login'),
(156, 'Can view login', 39, 'view_login'),
(157, 'Can add login1', 40, 'add_login1'),
(158, 'Can change login1', 40, 'change_login1'),
(159, 'Can delete login1', 40, 'delete_login1'),
(160, 'Can view login1', 40, 'view_login1');
...
(22, 'top_komraz', '0005_auto_20190513_1411', '2019-05-13 07:11:33.047698'),
(23, 'top_komraz', '0006_implemented', '2019-05-13 12:49:46.978003'),
(24, 'top_komraz', '0007_period_plan_procurement_plan', '2019-05-13 15:58:24.322337'),
(25, 'top_komraz', '0008_auto_20190514_0558', '2019-05-13 22:58:35.518347'),
(26, 'top_komraz', '0009_auto_20190514_0602', '2019-05-13 23:02:55.367851');
...
--
-- Дамп данных таблицы `implemented`
--

INSERT INTO `implemented` (`ID_certificate`, `Quantity`, `ID_Detail_id`) VALUES
(1, 5, 2),
(2, 6, 1),
(3, 3, 5),
(4, 3, 6);
...
CREATE TABLE `login1` (
  ...
  `Id_Employee_id` int(11) DEFAULT NULL,
  `Id_Master_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `login1`
--

INSERT INTO `login1` (`id_login`, `login`, `password`, `Id_Employee_id`, `Id_Master_id`) VALUES
...
(5, '5', 'ef2d127de37b942baad06145e54b0c619a1f22327b2ebbcfbec78f5564afe39d', NULL, 2),
(6, '6', 'e7f6c011776e8db7cd330b54174fd76f7d0216b612387a5ffcfb81e6f0919683', NULL, 3),
(7, '7', '7902699be42c8a8e46fbbb4501726517e86b22c56a189f7625a6da49081b2451', NULL, 4),
(8, '8', '2c624232cdd221771294dfbb310aca000a0df6ac8b66b696d90ef06fdefb64a3', NULL, NULL);
...
CREATE TABLE `plan` (
  `id_plan_delivery` int(11) NOT NULL,
  `Quantity` int(11) NOT NULL,
  `ID_Detail_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `plan` (`id_plan_delivery`, `Quantity`, `ID_Detail_id`) VALUES
(1, 5, 3),
(3, 78, 1);
...
--
-- Структура таблицы `procurement_plan1`
--

CREATE TABLE `procurement_plan1` (
  `id_plan` int(11) NOT NULL,
  `Date` date NOT NULL,
  `Quantity` int(11) NOT NULL,
  `Id_Employee_id` int(11) NOT NULL,
  `id_period_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `request_delivery3`
--

CREATE TABLE `request_delivery3` (
...
--
-- Дамп данных таблицы `request_delivery3`
--

INSERT INTO `request_delivery3` (`ID_request`, `Date`, `Quantity`, `ID_Detail_id`, `ID_Provider_id`) VALUES
(1, '2019-05-29', 1, 1, 1),
(2, '2019-05-21', 5, 2, 5),
(3, '2019-06-17', 6, 3, 3),
(4, '2019-05-31', 7, 4, 2),
...
--
-- Индексы таблицы `implemented`
--
ALTER TABLE `implemented`
  ADD PRIMARY KEY (`ID_certificate`),
  ADD KEY `implemented_ID_Detail_id_de77ab67_fk_detail_fix2_Id_Detail` (`ID_Detail_id`);
...
--
-- Индексы таблицы `login1`
--
ALTER TABLE `login1`
  ADD PRIMARY KEY (`id_login`),
  ADD KEY `login1_Id_Employee_id_0096abae_fk_employee_Id_Employee` (`Id_Employee_id`),
  ADD KEY `login1_Id_Master_id_ffd5e3f6_fk_master_Id_Master` (`Id_Master_id`);
...
--
ALTER TABLE `plan`
  ADD PRIMARY KEY (`id_plan_delivery`),
  ADD KEY `plan_ID_Detail_id_452ea98f_fk_detail_fix2_Id_Detail` (`ID_Detail_id`);

--
-- Индексы таблицы `procurement_plan1`
--
ALTER TABLE `procurement_plan1`
  ADD PRIMARY KEY (`id_plan`),
  ADD KEY `procurement_plan1_Id_Employee_id_acf67006_fk_employee_` (`Id_Employee_id`),
  ADD KEY `procurement_plan1_id_period_id_44fe7607_fk_period_id_period` (`id_period_id`);
...
--
-- Индексы таблицы `request_delivery3`
--
ALTER TABLE `request_delivery3`
  ADD PRIMARY KEY (`ID_request`),
  ADD KEY `request_delivery3_ID_Detail_id_b89570b1_fk_detail_fix2_Id_Detail` (`ID_Detail_id`),
  ADD KEY `request_delivery3_ID_Provider_id_3943eb00_fk_provider_` (`ID_Provider_id`);
...
--
ALTER TABLE `contract_fix2`
  MODIFY `Id_contract` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- AUTO_INCREMENT для таблицы `implemented`
--
ALTER TABLE `implemented`
  MODIFY `ID_certificate` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT для таблицы `login1`
--
ALTER TABLE `login1`
...
--
ALTER TABLE `plan`
  MODIFY `id_plan_delivery` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `procurement_plan1`
--
ALTER TABLE `procurement_plan1`
...
--
-- AUTO_INCREMENT для таблицы `request_delivery3`
--
ALTER TABLE `request_delivery3`
...
--
-- Ограничения внешнего ключа таблицы `implemented`
--
ALTER TABLE `implemented`
  ADD CONSTRAINT `implemented_ID_Detail_id_de77ab67_fk_detail_fix2_Id_Detail` FOREIGN KEY (`ID_Detail_id`) REFERENCES `detail_fix2` (`Id_Detail`);

--
-- Ограничения внешнего ключа таблицы `login1`
--
ALTER TABLE `login1`
  ADD CONSTRAINT `login1_Id_Employee_id_0096abae_fk_employee_Id_Employee` FOREIGN KEY (`Id_Employee_id`) REFERENCES `employee` (`Id_Employee`),
  ADD CONSTRAINT `login1_Id_Master_id_ffd5e3f6_fk_master_Id_Master` FOREIGN KEY (`Id_Master_id`) REFERENCES `master` (`Id_Master`);
...
--
ALTER TABLE `plan`
  ADD CONSTRAINT `plan_ID_Detail_id_452ea98f_fk_detail_fix2_Id_Detail` FOREIGN KEY (`ID_Detail_id`) REFERENCES `detail_fix2` (`Id_Detail`);

--
-- Ограничения внешнего ключа таблицы `procurement_plan1`
--
ALTER TABLE `procurement_plan1`
  ADD CONSTRAINT `procurement_plan1_Id_Employee_id_acf67006_fk_employee_` FOREIGN KEY (`Id_Employee_id`) REFERENCES `employee` (`Id_Employee`),
  ADD CONSTRAINT `procurement_plan1_id_period_id_44fe7607_fk_period_id_period` FOREIGN KEY (`id_period_id`) REFERENCES `period` (`id_period`);

--
-- Ограничения внешнего ключа таблицы `request_delivery3`
--
ALTER TABLE `request_delivery3`
  ADD CONSTRAINT `request_delivery3_ID_Detail_id_b89570b1_fk_detail_fix2_Id_Detail` FOREIGN KEY (`ID_Detail_id`) REFERENCES `detail_fix2` (`Id_Detail`),
  ADD CONSTRAINT `request_delivery3_ID_Provider_id_3943eb00_fk_provider_` FOREIGN KEY (`ID_Provider_id`) REFERENCES `provider` (`ID_Provider`);
